...
import com.facultytimetable.pro.presentation.department.DepartmentFormViewModel
import com.facultytimetable.pro.presentation.common.components.LoadingState
import com.facultytimetable.pro.presentation.common.components.DropdownSelector

// Reuse the same pattern as DepartmentForm - full ViewModel in same file for brevity
        ...
        if (state.isLoading) {
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Subject Code *") }, modifier = Modifier.fillMaxWidth(),
                    singleLine = true, shape = MaterialTheme.shapes.medium,
                    keyboardOptions = KeyboardOptions(imeAction = ImeAction.Next)
                )
                Spacer(modifier = Modifier.height(12.dp))
                ...
                Text("Subject Type", style = MaterialTheme.typography.labelMedium,
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Hours Per Week") }, modifier = Modifier.fillMaxWidth(),
                    singleLine = true, shape = MaterialTheme.shapes.medium,
